...
export function TapingMachineSpecifications() {
  ...
  const descriptionContent = (
    <>
      <h2 className="text-2xl font-bold mb-2">Taping and Packaging Machine</h2>
      <p>
        ...
        They are suitable for <strong>wheel weights for aluminum wheels</strong>, <strong>motorcycle wheel weight</strong>, and <strong>truck wheel weight</strong>.<br/><br/>
      </p>
    </>
  );
